...
LARGE_INTEGER convert_time(timeval t) {
	LARGE_INTEGER wft;
	wft.QuadPart = ((static_cast<ULONGLONG>(t.tv_sec) + 11644473600) * 10000000) + (t.tv_usec * 10);
	return wft;
}
...
DWORD WINAPI gd_watchdog(LPVOID) {
